-- TB_CHARACTER
INSERT INTO tb_character (name, also_known_as, type, description, path_to_image) VALUES ('Sheldon','Sheldon Lee Cooper','Protagonista', 'Dr. Sheldon Lee Cooper, B.Sc., M.Sc., M.A., Ph.D., Sc.D., is a Caltech theoretical physicist. Next to his best friend Leonard Hofstadter, he is the main protagonist of The Big Bang Theory.','http://localhost:8080/img/sheldon.jpg');
INSERT INTO tb_character (name, also_known_as, type, description, path_to_image) VALUES ('Leonard','Leonard Leakey Hofstadter','Protagonista', 'Dr. Leonard Leakey Hofstadter, Ph.D., is an experimental physicist at the California Institute of Technology. Originally from New Jersey, Leonard attended Princeton University and was twenty-four years old when he received his doctorate.','http://localhost:8080/img/leonard.jpg');
INSERT INTO tb_character (name, also_known_as, type, description, path_to_image) VALUES ('Penny','Penny Hofstadter','Protagonista', 'Penny Hofstadter is the primary female character in the series. She lives in Apartment 4A with her husband Leonard Hofstadter across the hall from Sheldon Cooper and Amy Farrah Fowler who live in apartment 4B where Penny used to live.','http://localhost:8080/img/penny.jpg');
INSERT INTO tb_character (name, also_known_as, type, description, path_to_image) VALUES ('Ammy','Amy Farrah Fowler','Protagonista', 'Dr. Amy Farrah Fowler, Ph.D., is a neurobiologist. She initially was discovered by Raj and Howard as a possible match for Sheldon through an online dating service.','http://localhost:8080/img/ammy.jpg');
INSERT INTO tb_character (name, also_known_as, type, description, path_to_image) VALUES ('Howard','Howard Joel Wolowitz','Protagonista', 'Howard Joel Wolowitz, M.Eng., is a Jewish aerospace engineer and ex-astronaut. As the best friend of Rajesh Koothrappali, Howard often hangs out at Leonard and Sheldon''s apartment with him.','http://localhost:8080/img/howard.jpg');
INSERT INTO tb_character (name, also_known_as, type, description, path_to_image) VALUES ('Raj','Rajesh Ramayan Koothrappali','Protagonista', 'Dr. Rajesh Ramayan "Raj" Koothrappali, Ph.D., is an astrophysicist and Howard Wolowitz''s best friend. He often hangs out at Leonard and Sheldon''s apartment, though he has his own apartment (the Raj Mahal) in Pasadena.','http://localhost:8080/img/raj.jpg');
INSERT INTO tb_character (name, also_known_as, type, description, path_to_image) VALUES ('Bernadette','Bernadette Maryann Rostenkowski-Wolowitz','Protagonista', 'Bernadette is a supporting character of The Big Bang Theory and a former waitress at the Cheesecake Factory and has earned her Ph.D. in microbiology who has a lucrative job at the pharmaceutical company ZanGen.','http://localhost:8080/img/bernadette.jpg');
